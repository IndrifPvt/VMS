...
public class CameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
       ...
       int  mScreenHeight = displaymetrics.heightPixels;
        ...
        rec.set((int)((double)mScreenWidth*.45),
                (int)((double)mScreenHeight*.60) ,
                (int)((double)mScreenWidth*.45),
...
//        });
        ...
        changeCameraFlashModeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mFlashMode.equalsIgnoreCase(Camera.Parameters.FLASH_MODE_TORCH)) {
...
//                        Double[] ratio = getRatio();
    ...
    private void setupFlashMode() {
        ...
        } else if (Camera.Parameters.FLASH_MODE_TORCH.equalsIgnoreCase(mFlashMode)) {
